...
abstract class FirebaseStoreRespository {
...
class FirebaseStoreRepositoryImpl implements FirebaseStoreRespository {
  const FirebaseStoreRepositoryImpl(this.documentRef);
